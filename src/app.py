...
activities = {
    ...
    "Soccer": {
        "description": "Play soccer and develop team coordination skills",
    ...
    "Music Ensemble": {
        "description": "Join our choir and orchestra to perform classical and contemporary music",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore STEM topics through hands-on activities",
...
def unsignup_for_activity(activity_name: str, email: str):
